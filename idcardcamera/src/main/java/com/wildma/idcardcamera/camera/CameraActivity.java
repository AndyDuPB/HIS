...
public class CameraActivity extends Activity implements View.OnClickListener {
    ...
    private void init() {
        ...
        mFilePath = getIntent().getStringExtra(IDCardCamera.IMAGE_PATH);
    ...
    private void confirm() {
        ...
        mCropImageView.crop(new CropListener() {
            ...
            public void onFinish(Bitmap bitmap) {
                ...
                /*保存图片到sdcard并返回图片路径*/
                if (ImageUtils.save(bitmap, mFilePath, Bitmap.CompressFormat.JPEG)) {
                    Intent intent = new Intent();
                    intent.putExtra(IDCardCamera.IMAGE_PATH, mFilePath);
